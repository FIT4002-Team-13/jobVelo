    ...
    <div className="flex h-screen bg-neutral-50 font-sans">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="bg-neutral-0 border-b border-neutral-200 px-10 py-4 shrink-0">
          <button
            onClick={() => navigate(-1)}
            className={`${flex.row} gap-2 mb-3 rounded-lg border border-neutral-200 bg-neutral-0 px-3 py-1.5 text-sm font-semibold text-neutral-600 transition-colors hover:border-primary-200 hover:bg-primary-500/10 hover:text-primary-600 shrink-0`}
          >
