...
//         // Interviewer is linked through interview_users, then resolved from users.
      ...
      <div className={flex.rowBetween}>
        ...
        <div className="flex items-center gap-3">
          <button
            type="button"
            onClick={onEdit}
            className="rounded-pill border border-neutral-200 hover:bg-neutral-50 bg-white px-4 py-0.5 text-[14px] font-semibold text-neutral-500"
          >
            Edit
          </button>
